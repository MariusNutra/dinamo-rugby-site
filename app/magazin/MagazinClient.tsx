      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h2 className="font-heading text-xl font-bold text-dinamo-blue mb-2">În curând</h2>
            <p className="text-gray-500">Produsele vor fi disponibile în curând. Reveniți pentru noutăți!</p>
          </div>
        ) : (
