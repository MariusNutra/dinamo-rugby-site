  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
        ...
        {/* Right side: App link + Portal Parinti + Hamburger */}
        <div className="flex items-center gap-2">
          <a href="https://app.dinamorugby.ro" target="_blank" rel="noopener noreferrer"
            className="hidden lg:flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-gray-600 hover:text-dinamo-red transition-colors rounded-md hover:bg-gray-50">
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-[100] bg-white lg:hidden flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4">
            ...
            <a href="https://app.dinamorugby.ro" target="_blank" rel="noopener noreferrer"
              onClick={() => setMobileOpen(false)}
              className="flex items-center gap-2 py-3 text-base font-medium text-gray-800 border-b border-gray-100"
              style={{ minHeight: '44px' }}>
              <svg className="w-5 h-5 text-dinamo-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
              </svg>
              Aplicatie Dinamo Rugby
            </a>
          </div>
          ...
          <div className="flex-shrink-0 border-t border-gray-200 px-4 py-4">
            <div className="flex items-center justify-center gap-4">
              <a href="https://www.facebook.com/profile.php?id=61592998121958" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://www.tiktok.com/@dinamo.rugby" target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 text-gray-600 hover:bg-dinamo-red hover:text-white transition-colors">
